...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙy ꜰᴀꜱᴡᴇᴇʜ' : process.env.ALL_CAPTION,
    ...
    ALIVEURL: process.env.ALIVE_URL === undefined ? 'https://m.imgur.com/DyLAuEh.jpg' : process.env.ALIVE_URL,
    AFNN: process.env.TAG_REPLY === undefined ? '916235261803@s.whatsapp.net' : process.env.TAG_REPLY,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLKIMG: process.env.LIST_IMG === undefined ? 'https://i.imgur.com/8c7F2iS.jpg' : process.env.LIST_IMG,
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://i.imgur.com/nErXUGj.mp4' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/Z1jCYGN.mp4' : process.env.GIF_BYE,
    BOTPLK: process.env.BOT_NAME === undefined ? '•━━━╼⤏ɪɴʀʟ ʙᴏᴛ⤎╾━━━•' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    TALKING_INRL: process.env.TALKING_INRL === undefined ? 'false' : process.env.TALKING_INRL,
