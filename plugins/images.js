...
if (Config.WORKTYPE == 'private') {
    ...
    faz.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'ᴍᴀᴅᴇ ʙʏ ғᴀsᴡᴇᴇʜ'})

    }));
    
    faz.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    faz.addCommand({pattern: 'pink', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "inrline tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "inrl says i love you 😘";
r_text[3] = "inrlude yudhangal Company Kanan Povunnatheyuloo";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per inrl ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than fasweeh";
...
r_text[18] = "enikk njan und inrl uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe inrl pazhaya inrl thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik inrlik";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. inrl";
...
await message.sendMessage(r_text[i]);
    ...
    faz.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
    ...
    faz.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    faz.addCommand({pattern: 'pink', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "inrle tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "inrl says i love you 😘";
r_text[3] = "inrlude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
