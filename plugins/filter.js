...
inrl.addCommand({pattern: 'filter ?(.*)', fromMe: true, desc: Lang.FILTER_DESC, dontAddCommandList: true}, (async (message, match) => {
...
inrl.addCommand({pattern: 'stop ?(.*)', fromMe: true, desc: Lang.STOP_DESC, dontAddCommandList: true}, (async (message, match) => {
    match = match[1].match(/[\'\"\“](.*?)[\'\"\“]/gsm);
    if (match === null) {
...
await message.client.sendMessage(message.jid, fs.readFileSync('./media/media/fasweeh.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, quoted : message.data, ptt: true})
        }
...
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./media/media/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, quoted: message.data, ptt: true})
}
});
    }
...
await message.client.sendMessage(message.jid, fs.readFileSync('./media/media/fasweeh.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, quoted : message.data, ptt: true})
        ...
        if (!!message.mention && message.mention[0] == Config.AFNN) {
await message.client.sendMessage(message.jid, fs.readFileSync('./mdia/bgmone/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.DURATION, quoted : message.data, ptt: true})
        }
...
inrl.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    ...
    if(banned !== undefined) return
    if (!!message.mention && message.mention[0] == '916235261803@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./mdia/stickers/bot.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
